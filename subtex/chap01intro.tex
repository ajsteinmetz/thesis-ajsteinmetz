...
\end{gather}
The electric dipole is important because the presence of one would signify CP violation in the theory. This is demonstrated in brief because of the parity (P) and time (T) symmetries of the relevant vectors and their inner products. Even and odd symmetries for each are printed in \rt{fig:cp}. Notably, the magnetic dipole is even under both P and T symmetry while the electric dipole is odd under both.
