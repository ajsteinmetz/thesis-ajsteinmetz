...
The dependancy on particle energy during expansion in \req{EScale} will be useful when we describe the statistical physics in $\Lambda{\rm CDM}$ in \rchap{chap:cosmo}. The Boltzmann statistical factor is given by
\begin{alignat}{1}
